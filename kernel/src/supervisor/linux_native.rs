...
impl LinuxFrontend {
    ...
    fn dispatch_futex(
        ...
        self.plan_futex(key, op, val, timeout_ms, current_word)
    }
    ...
    fn plan_bind(&mut self, fd: u64, addr: u64, addr_len: u64) -> PackedStep {
        self.reset_plan(PlanKind::Bind, [fd, addr, addr_len, 0, 0, 0]);
