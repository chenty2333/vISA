    ...
    pub fn migration_package(
        ...
        MigrationPackage {
            ...
            semantic: SemanticSnapshot {
                harts: self.domains.scheduler.harts.clone(),
                ...
                tasks: self.domains.scheduler.tasks.clone(),
                resources: self.domains.resource.resources.clone(),
                authority_bindings: self.domains.resource.authority_bindings.clone(),
                waits: self.domains.wait.waits.clone(),
                fault_domains: self.domains.lifecycle.fault_domains.clone(),
                stores: self.domains.lifecycle.stores.clone(),
                transactions: self.domains.lifecycle.transactions.clone(),
                fast_path_plans: self.domains.lifecycle.fast_path_plans.clone(),
                boundaries: self.domains.runtime.boundaries.clone(),
                artifact_verifications: self.domains.runtime.artifact_verifications.clone(),
                store_activations: self.domains.runtime.store_activations.clone(),
