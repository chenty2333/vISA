//! Historical vISA effect-language comparison oracle.
//!
//! This crate is frozen outside Stage 1 production. The canonical portable
//! contract lives in `contract_core`. This oracle
