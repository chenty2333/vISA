...
pub struct DefectCase {
    ...
    /// Boundary entries are reported but excluded from detection-rate
    /// denominators because they encode a deliberate specification limit
    /// rather than a defect the verifier is meant to catch.
    pub boundary: bool,
