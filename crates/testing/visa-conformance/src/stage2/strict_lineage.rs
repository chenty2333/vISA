...
use super::{
    ...
    model::{
        ...
        STAGE2_WACOGO_SIDECAR_SHA256, STAGE2_WACOGO_SIDECAR_SIZE, STAGE2_WACOGO_SOURCE_LOCK_SHA256,
...
pub const STAGE2_STRICT_WACOGO_SOURCE_LOCK_SHA256: &str = STAGE2_WACOGO_SOURCE_LOCK_SHA256;
pub const STAGE2_STRICT_WACOGO_SIDECAR_SHA256: &str = STAGE2_WACOGO_SIDECAR_SHA256;
pub const STAGE2_STRICT_WACOGO_SIDECAR_SIZE: usize = STAGE2_WACOGO_SIDECAR_SIZE as usize;
