...
pub const STAGE1_EVIDENCE_SCHEMA_VERSION: &str = "visa-stage1-evidence-v0.5";
pub const STAGE1_MATRIX_SCHEMA_VERSION: &str = "visa-stage1-matrix-provenance-v3";
...
pub fn stage1_timer_delay_ns(case_id: &str) -> u64 {
    match case_id {
        ...
        "timer-semantics-unsupported" => STAGE1_TIMER_UNSUPPORTED_DELAY_NS,
        _ => STAGE1_DEFAULT_TIMER_DELAY_NS,
    }
}
