...
fn c1_manifest_stub() -> ArtifactBundleManifest {
    ArtifactBundleManifest {
        ...
        contract: artifact_manifest::SupervisorContractManifest {
            contract_version: "visa-supervisor-contract-v2".to_owned(),
        ...
        target: artifact_manifest::TargetManifest {
            ...
            machine_abi_version: "visa-machine-abi-v0".to_owned(),
            supervisor_abi_version: "visa-supervisor-abi-v0".to_owned(),
            ...
            network_contract_version: "visa-network-contract-v2".to_owned(),
        },
