...
use vmos_abi::{
    ...
    FUTEX_WAIT_REQUEUE_PI, FUTEX_WAITERS, FUTEX_WAKE, FUTEX_WAKE_BITSET, SO_ERROR, SO_REUSEADDR,
    SO_REUSEPORT, SO_TYPE, SOCK_DGRAM, SOCK_RAW, SOCK_STREAM, SOL_SOCKET, SYS_ACCEPT, SYS_ACCEPT4,
    ...
    SYS_LSEEK, SYS_LSTAT, SYS_MADVISE, SYS_MKDIR, SYS_MKDIRAT, SYS_MKNODAT, SYS_MMAP, SYS_MOUNT,
    SYS_MPROTECT, SYS_MREMAP, SYS_MSYNC, SYS_MUNMAP, SYS_NANOSLEEP, SYS_NEWFSTATAT, SYS_OPEN,
...
fn restartable_interrupted_syscall(frame: &SyscallFrame, syscall_nr: u64) -> bool {
    match syscall_nr {
        ...
        | SYS_SENDTO | SYS_RECVFROM | SYS_FLOCK => true,
