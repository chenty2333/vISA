...
use vmos_abi::{
    ...
    SO_ACCEPTCONN, SO_ERROR, SO_REUSEADDR, SO_REUSEPORT, SO_TYPE, SOCK_DGRAM, SOCK_RAW,
    SOCK_STREAM, SOL_SOCKET, SYS_ACCEPT, SYS_ACCEPT4, SYS_ACCESS, SYS_ADD_KEY, SYS_ALARM,
    ...
    SYS_MADVISE, SYS_MKDIR, SYS_MKDIRAT, SYS_MKNODAT, SYS_MLOCK, SYS_MLOCK2, SYS_MLOCKALL,
    SYS_MMAP, SYS_MOUNT, SYS_MPROTECT, SYS_MREMAP, SYS_MSYNC, SYS_MUNLOCK, SYS_MUNLOCKALL,
    SYS_MUNMAP, SYS_NANOSLEEP, SYS_NEWFSTATAT, SYS_OPEN, SYS_OPENAT, SYS_PAUSE, SYS_PIPE,
    SYS_PIPE2, SYS_POLL, SYS_PPOLL, SYS_PRCTL, SYS_PREADV, SYS_PREADV2, SYS_PRLIMIT64,
...
fn write_getsockopt_u32(
    ...
    if level != SOL_SOCKET
        || !matches!(optname, SO_ERROR | SO_TYPE | SO_REUSEADDR | SO_REUSEPORT | SO_ACCEPTCONN)
    {
        return Err(ERR_EOPNOTSUPP);
    }
