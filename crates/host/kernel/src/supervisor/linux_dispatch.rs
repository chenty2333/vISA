...
impl<'engine> PrototypeRuntime<'engine> {
    ...
    fn execute_linux_plan(
        ...
        match plan.kind {
            ...
            PlanKind::FutexCmpRequeuePi => self.plan_futex_cmp_requeue_pi(plan),
            ...
            PlanKind::SendMsg => self.plan_sendmsg(plan),
            ...
            PlanKind::Mlock => self.plan_mlock(plan),
            PlanKind::Munlock => self.plan_munlock(plan),
            PlanKind::Mlockall => self.plan_mlockall(plan),
            ...
            PlanKind::RtSigpending => self.plan_rt_sigpending(plan),
            ...
            PlanKind::GetUid => self.plan_getuid(plan),
            PlanKind::GetGid => self.plan_getgid(plan),
            PlanKind::GetEuid => self.plan_geteuid(plan),
            PlanKind::GetEgid => self.plan_getegid(plan),
            PlanKind::SetUid => self.plan_setuid(plan),
            PlanKind::SetGid => self.plan_setgid(plan),
            PlanKind::SetReUid => self.plan_setreuid(plan),
            PlanKind::SetReGid => self.plan_setregid(plan),
            PlanKind::SetResUid => self.plan_setresuid(plan),
            ...
            PlanKind::CapSet => self.plan_capset(plan),
