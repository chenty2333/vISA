...
pub(crate) fn hostcall_binding(kind: PlanKind) -> HostcallBinding {
    match kind {
        ...
        PlanKind::RtSigaction => HostcallBinding {
            class: HostcallClass::ImmediatePrivilegedOp,
            subject: "linux_syscall",
            object: "signal.disposition",
            operation: "sigaction",
        },
        PlanKind::RtSigprocmask => HostcallBinding {
            class: HostcallClass::ImmediatePrivilegedOp,
            subject: "linux_syscall",
            object: "signal.mask",
        ...
        PlanKind::FutexRequeue | PlanKind::FutexCmpRequeue | PlanKind::FutexCmpRequeuePi => {
            HostcallBinding {
                class: HostcallClass::ImmediatePrivilegedOp,
                subject: "futex_service",
                object: "futex.waitset",
        ...
        PlanKind::SendMsg => HostcallBinding {
            class: HostcallClass::ImmediatePrivilegedOp,
            subject: "linux_syscall",
            object: "linux.socket",
            operation: "sendmsg",
        ...
        PlanKind::Shutdown => HostcallBinding {
            class: HostcallClass::ImmediatePrivilegedOp,
            subject: "linux_syscall",
            object: "linux.socket",
            operation: "shutdown",
