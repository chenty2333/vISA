...
pub fn validate_semantic_roots(package: &MigrationPackageManifest) -> ContractResult<()> {
    ...
    {
        return Err(ContractError::new(
            "framebuffer dirty region root/count mismatch",
        ));
    }
...
mod tests {
    ...
    fn semantic_roots_reject_block_write_path_root_mismatch() {
        ...
        package
            .semantic
            .block_write_paths
            .push(artifact_manifest::BlockWritePathManifest {
                id: 59,
                backend_kind: "fake-block-backend-object".to_owned(),
                backend: 56,
                backend_generation: 1,
    ...
    fn semantic_roots_reject_buffer_cache_object_root_mismatch() {
        ...
        package
            ...
            .push(artifact_manifest::BufferCacheObjectManifest {
                id: 63,
    ...
    fn semantic_roots_reject_ext4_adapter_object_root_mismatch() {
        ...
        package
            ...
            .push(artifact_manifest::Ext4AdapterObjectManifest {
                id: 67,
                directory_object: 65,
                directory_object_generation: 1,
                file_object: 64,
    ...
    fn semantic_roots_reject_display_capability_root_mismatch() {
        ...
        package
            ...
            .push(artifact_manifest::DisplayCapabilityManifest {
                id: 92,
                owner_store: 7,
                owner_store_generation: 1,
                display: 91,
    ...
    fn semantic_roots_reject_framebuffer_write_root_mismatch() {
        ...
        package
            .semantic
            .framebuffer_writes
            .push(artifact_manifest::FramebufferWriteManifest {
                id: 95,
                owner_store: 7,
                owner_store_generation: 1,
    ...
    fn semantic_roots_reject_display_event_log_root_mismatch() {
        ...
        package
            .semantic
            .display_event_logs
            .push(artifact_manifest::DisplayEventLogManifest {
                id: 98,
                owner_store: 7,
                owner_store_generation: 1,
                display_capability: 92,
